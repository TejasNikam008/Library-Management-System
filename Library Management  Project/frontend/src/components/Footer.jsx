...
export default function Footer() {
    return (
        <>
            <footer className="text-dark pt-4 m-5 shadow p-3 mb-5 bg-success rounded">
                <div className="container">
                    <div className="row">
                        ...
                        <div className="col-md-4">
                            ...
                            <p><i className="bi bi-geo-alt-fill"></i> ShivShakti Chowk,Cidco,Nashik</p>
                            <p><i className="bi bi-telephone-fill"></i>+91-8669664861</p>
                    ...
                    <div className="row mt-4">
                        <div className="col text-center">
                            <p className="text-muted mb-0">&copy; 2025 Library Management System. All rights reserved.</p>
                        </div>
                    </div>
                </div>
            </footer>
